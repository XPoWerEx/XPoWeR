...
if io.open("File_Libs/redis.lua","r") then
io.close(io.open("File_Libs/redis.lua","r"))
print("done => redis.lua")
else
io.popen("cd File_Libs && wget https://raw.githubusercontent.com/XPoWerEx/XPoWeR/main/File_Libs/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/XPoWerEx/XPoWeR/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevXPoWeRW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local XPoWeR_Msg = ''  
if msgs < 100 then 
XPoWeR_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
XPoWeR_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
XPoWeR_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
XPoWeR_Msg = 'متفاعل' 
elseif msgs < 1200 then 
XPoWeR_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
XPoWeR_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
XPoWeR_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
XPoWeR_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
XPoWeR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
XPoWeR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
XPoWeR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
XPoWeR_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
XPoWeR_Msg = 'رب التفاعل'  
end 
return XPoWeR_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@Mooaiud")  
...
--------------------------------------------------------------------------------------------------------------
function SourceXPoWeR(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."XPoWeR1:List:Filter"..sl)
...
if not DevXPoWeRW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevXPoWeRW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,XPoWeR_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✬' and DevXPoWeRW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevXPoWeRW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevXPoWeRW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevXPoWeRW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevXPoWeRW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✬︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevXPoWeRW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevXPoWeRW(msg) then 
...
if text == 'الاصدار ✬' and DevXPoWeRW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙اصدار سورس اكس باور* \n*✬︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevXPoWeRW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/SourceXPower) \n✬︙[قناه السورس](t.me/SourceXPower)')
end
if text == "ضع اسم للبوت ✬" and DevXPoWeRW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✬' and DevXPoWeRW(msg) then 
...
if text == 'المشتركين ✬' and DevXPoWeRW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✬' and DevXPoWeRW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevXPoWeRW(msg) then
...
if text == ("قائمه العام ✬") and DevXPoWeRW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevXPoWeRW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevXPoWeRW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevXPoWeRW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevXPoWeRW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevXPoWeRW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevXPoWeRW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✬︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevXPoWeRW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevXPoWeRW(msg) then
...
if text == "تنظيف الكروبات ✬" and DevXPoWeRW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✬︙عدد الكروبات الان » { '..#group..' }'..XPoWeRk..''..XPoWeR..'*\n*✬︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevXPoWeRW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevXPoWeRW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevXPoWeRW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevXPoWeRW(msg) then
...
local XPoWeR1_Msg = database:get(bot_id.."XPoWeR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if XPoWeR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceXPower')..') \n ✬︙'..XPoWeR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if XPoWeR_Msg and not Special(msg) then  
local XPoWeR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if XPoWeR_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..XPoWeR_Msg.."] \n")
else
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/SourceXPower)}\n✬︙["..XPoWeR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/SourceXPower)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevXPoWeRW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevXPoWeRW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevXPoWeRW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevXPoWeRW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevXPoWeRW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✬︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevXPoWeRW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevXPoWeRW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevXPoWeRW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✬︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevXPoWeRW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."XPoWeR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."XPoWeR:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_XPoWeR = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_XPoWeR then 
names_XPoWeR = database:smembers(bot_id.."XPoWeR:blocname"..msg.chat_id_) or ""
if names_XPoWeR and names_XPoWeR[1] then 
for i=1,#names_XPoWeR do 
if name_XPoWeR:match("(.*)("..names_XPoWeR[i]..")(.*)") then 
...
database:set(bot_id.."XPoWeR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."XPoWeR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."XPoWeR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."XPoWeR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."XPoWeR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_XPoWeRa_new(XPoWeR1,XPoWeR2)
if XPoWeR2 and XPoWeR2.first_name_ then 
if XPoWeR2.first_name_:match("(.*)"..database:get(bot_id.."XPoWeR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local XPoWeR_nnn = database:get(bot_id.."XPoWeR:nump"..msg.chat_id_) or 5
local XPoWeR_nnn2 = database:get(bot_id.."XPoWeR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(XPoWeR_nnn2) == tonumber(XPoWeR_nnn) or tonumber(XPoWeR_nnn2) > tonumber(XPoWeR_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."XPoWeR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬︙عزيزي >>["..XPoWeR2.username_.."](https://t.me/"..(XPoWeR2.username_ or "SourceXPower")..")\n✬︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."XPoWeR:teh"..msg.chat_id_).."} بجانب اسمك\n✬︙عدد المحاولات المتبقيه {"..(tonumber(XPoWeR_nnn) - tonumber(XPoWeR_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_XPoWeRa_new)
end
end
...
local XPoWeRChengName = database:get(bot_id.."XPoWeR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if XPoWeRChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..XPoWeRChengName..']')
database:del(bot_id.."XPoWeR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if XPoWeRChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."XPoWeR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local XPoWeRChengUserName = database:get(bot_id.."XPoWeR:Cheng:UserName"..data.id_)
if not data.username_ then 
if XPoWeRChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..XPoWeRChengUserName..']')
database:del(bot_id.."XPoWeR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if XPoWeRChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."XPoWeR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local XPoWeRChengPhoto = database:get(bot_id.."XPoWeR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if XPoWeRChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."XPoWeR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if XPoWeRChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."XPoWeR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://XPoWeR-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @SourceXPower .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ XPoWeR\n\n[-  XPoWeR ᴄʜᴀɴɴᴇʟ  .](http://t.me/SourceXPower)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/SourceXPower)\n\n[-  XPoWeR ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/Mooaiud)\n\n[-  ʙᴏᴛ XPoWeR .](http://t.me/u5kBoT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: XPoWeR sᴏᴜʀᴄʀ .',url="t.me/SourceXPower/567"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevXPoWeRW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://XPoWeR-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceXPower')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceXPower')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevXPoWeRW(msg) then
dofile('XPoWeR.lua')  
send(msg.chat_id_, msg.id_, ' *✬︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevXPoWeRW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevXPoWeRW(msg) then  
function start_function(extra, result, success)
if XPoWeRSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevXPoWeRW(msg) then  
...
if XPoWeRSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevXPoWeRW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if XPoWeRSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevXPoWeRW(msg) then  
function start_function(extra, result, success)
if XPoWeRSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevXPoWeRW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevXPoWeRW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if XPoWeRSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevXPoWeRW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevXPoWeRW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevXPoWeRW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevXPoWeRW(msg) then
...
if text == 'الملفات' and DevXPoWeRW(msg) then
t = ' *✬︙ملفات السورس اكس باور ↓*\n*•━━━━━━ XPoWeR ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
local TextE = "\n*•━━━━━━ XPoWeR ━━━━━━━•*\n *✬︙علامة تعني { ✓ } ملف مفعل*\n *✬︙علامة تعني { ✘ } ملف معطل*\n *✬︙قناة سورس اكس باور ↓*\n".." *✬︙*[اضغط هنا لدخول](t.me/SourceXPower) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevXPoWeRW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/XPoWerEx/XPoWeR/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('XPoWeR.lua')  
else
send(msg.chat_id_, msg.id_," *✬︙عذرا الملف لايدعم سورس اكس باور* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevXPoWeRW(msg) then
...
if text == "مسح الملفات" and DevXPoWeRW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✬︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevXPoWeRW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevXPoWeRW(msg) then  
function start_function(extra, result, success)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceXPower')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceXPower')..')'
...
database:set(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✬︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."XPoWeR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."XPoWeR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✬︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."XPoWeR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."XPoWeR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."XPoWeR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✬︙ارسل الكلمه الان*")  
database:set(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."XPoWeR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."XPoWeR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."XPoWeR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."XPoWeR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."XPoWeR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."XPoWeR1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevXPoWeRW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✬︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevXPoWeRW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SourceXPower')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevXPoWeRW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevXPoWeRW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اكس باور').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اكس باور')
local XPoWeR_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..XPoWeR_Msg[math.random(#XPoWeR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevXPoWeRW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,XPoWeR)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ XPoWeR ━━━━━━━•*\n"
x = 0
local list = XPoWeR.members_
for k, v in pairs(list) do
x = x + 1
...
if XPoWeRSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevXPoWeRW(msg) then 
...
if text == ("ردود المطور") and DevXPoWeRW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✬︙قائمة ردود المطور \n*•━━━━━━ XPoWeR ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevXPoWeRW(msg) then    
send(msg.chat_id_, msg.id_,' *✬︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevXPoWeRW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اكس باور').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevXPoWeRW(msg) then   
...
if text == 'تعطيل المغادره' and DevXPoWeRW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceXPower')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
XPoWeRdx(msg.chat_id_, msg.id_, ' *✬︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✬︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✬︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✬︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevXPoWeRW(msg) then
...
*✬م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ XPoWeR ━━━━━━━•*ٴ
[- sᴏᴜʀᴄʀ XPoWeR ](t.me/SourceXPower) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '- sᴏᴜʀᴄʀ XPoWeR', url="t.me/SourceXPower"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '- sᴏᴜʀᴄʀ XPoWeR', url="t.me/SourceXPower"}},
{{text = 'مطور السورس', url="t.me/Mooaiud"}},
}
...
zh = https.request('https://XPoWeR-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*✬︙قائمه الزخرفه* \nٴ✬∫ٴ*•━━━━━━ XPoWeR ━━━━━━━•*ٴ✬∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ✬∫ٴ*•━━━━━━ XPoWeR ━━━━━━━•*ٴ✬∫○ٴ\n✬︙[- sᴏᴜʀᴄʀ XPoWeR](t.me/SourceXPower) ')
end
...
gk = https.request('https://XPoWeR-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://XPoWeR-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://XPoWeR-api.ml/audios.php')
if res == 200 then
...
{{text = '~ XPoWeR •',url='http://t.me/SourceXPower'}},
}
...
https.request("https://XPoWeR-api.ml/Do/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://XPoWeR-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
Ok_id  = DAata:match("(%d+)")  
...
inline = {
{{text = 'sᴏᴜʀᴄʀ XPoWeR',url='http://t.me/SourceXPower'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اكس باور')
...
XPoWeR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(XPoWeR)
...
--------------------------------------------------------------------------------------------------------------
SourceXPoWeR(data.message_,data)
...
------------------------------------------------------------------------
local XPoWeRAbot = database:get(bot_id.."XPoWeR1:Add:Filter:Rp2"..text..result.chat_id_)   
if XPoWeRAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..XPoWeRAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local XPoWeR1_Msg = database:get(bot_id.."XPoWeR1:Add:Filter:Rp2"..text..result.chat_id_)   
if XPoWeR1_Msg then
send(msg.chat_id_, msg.id_," ✬︙"..XPoWeR1_Msg)
