...
Name_Bot = redis:get(bot_id.."Redis:Name:Bot") or "اكس باور"
------------------------------------------------------------------------------------------------------------
function var(value)  
...
if data.Ch_Member.SourceXPower  ~= true then
Var = false
else
Var = true
end
...
if tonumber(msg.sender_user_id_) == tonumber(1149393139) then
