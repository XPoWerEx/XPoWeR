...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1149393139}
User = io.popen("whoami"):read('*a'):gsub('[\n\r]+', '')
print("\27[34m"..[[>> Your bot has been activated on the XPoWeR source]].."\27[m")
io.popen("mkdir XPoWeR_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls XPoWeR_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."XPoWeR:Sudo:User", msg.sender_user_id_) 
if hash or Bot(msg) or DevXPoWeR(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBot(msg) or DevXPoWeR(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevXPoWeR(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."XPoWeR:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Bot(msg) or DevXPoWeR(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."XPoWeR:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevXPoWeR(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."XPoWeR:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevXPoWeR(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."XPoWeR:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Bot(msg) or DevXPoWeR(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
...
function Vips(msg)
local hash = database:sismember(bot_id.."XPoWeR:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Bot(msg) or  DevXPoWeR(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
var = true
elseif DevXPoWeR(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1149393139) then  
var = true  
elseif tonumber(user_id) == tonumber(1149393139) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."XPoWeR:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."creator"..chat_id, user_id) then
var = true                
elseif database:sismember(bot_id.."XPoWeR:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."XPoWeR:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."XPoWeR:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."XPoWeR:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."XPoWeR:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
elseif tonumber(user_id) == tonumber(1149393139) then  
var = "مطور السورس"  
elseif DevXPoWeRe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then  var = "المطور الاساسي²"  
elseif database:sismember(bot_id.."XPoWeR:Sudo:User", user_id) then
var = database:get(bot_id.."XPoWeR:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."creator"..chat_id,user_id) then var = "المالك"
elseif database:sismember(bot_id.."XPoWeR:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."XPoWeR:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."XPoWeR:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."XPoWeR:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."XPoWeR:Manager"..chat_id, user_id) then
var = database:get(bot_id.."XPoWeR:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."XPoWeR:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."XPoWeR:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."XPoWeR:MN:TF"..chat_id, user_id) then
var =  "منظف"  
elseif database:sismember(bot_id.."XPoWeR:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."XPoWeR:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."XPoWeR:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."XPoWeR:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."XPoWeR:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."XPoWeR:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."XPoWeR:GBan:User",User_id) then
Var = true
else
Var = false
end
...
duration_ = "",
title_ = title or "",
performer_ = "سورس اكس باور الرسمي",
caption_ = caption or ""
}},func or dl_cb,nil)
end
...
local UserName = (data.username_ or "SourceXPower")
local NameUser = "[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
database:sadd(bot_id..'XPoWeR:Chek:Groups',idg) 
database:set(bot_id.."XPoWeR:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'XPoWeR:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."XPoWeR:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."XPoWeR:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."XPoWeR:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."XPoWeR:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."XPoWeR:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function XPoWeR_Files(msg)
for v in io.popen('ls XPoWeR_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("XPoWeR_Files/"..v)
if plugin.XPoWeR and msg then
pre_msg = plugin.XPoWeR(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function XPoWeR_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'XPoWeR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'XPoWeR:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."XPoWeR:XPoWeR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء الاذاعه") 
database:del(bot_id.."XPoWeR:XPoWeR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."XPoWeR:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'XPoWeR:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'XPoWeR:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'XPoWeR:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'XPoWeR:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."XPoWeR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."XPoWeR:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."XPoWeR:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."XPoWeR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."XPoWeR:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."XPoWeR:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."XPoWeR:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."XPoWeR:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."XPoWeR:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."XPoWeR:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."XPoWeR:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."XPoWeR:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."XPoWeR:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."XPoWeR:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."XPoWeR:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."XPoWeR:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."XPoWeR:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."XPoWeR:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."XPoWeR:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."XPoWeR:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."XPoWeR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."XPoWeR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."XPoWeR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"❈︙تم الغاء وضع الوصف") 
database:del(bot_id.."XPoWeR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."XPoWeR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."XPoWeR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"❈︙تم الغاء حفظ الترحيب") 
database:del(bot_id.."XPoWeR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."XPoWeR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."XPoWeR:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"❈︙تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."XPoWeR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"❈︙تم الغاء حفظ الرابط")       
database:del(bot_id.."XPoWeR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."XPoWeR:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."XPoWeR:XPoWeR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء الاذاعه للخاص") 
database:del(bot_id.."XPoWeR:XPoWeR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'XPoWeR:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."XPoWeR:XPoWeR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء الاذاعه") 
database:del(bot_id.."XPoWeR:XPoWeR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."XPoWeR:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."XPoWeR:XPoWeR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء الاذاعه") 
database:del(bot_id.."XPoWeR:XPoWeR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."XPoWeR:XPoWeR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء الاذاعه") 
database:del(bot_id.."XPoWeR:XPoWeR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."XPoWeR:UsersBot")   
...
local XPoWeR_Msg = database:sismember(bot_id.."XPoWeR:List:Filter:text"..msg.chat_id_,text) 
if XPoWeR_Msg then    
...
if msg.content_.ID == 'MessageAnimation' and not Vips(msg) then      
local geAni = database:sismember(bot_id.."XPoWeR:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_) 
if geAni then        
...
if msg.content_.ID == 'MessageSticker' and not Vips(msg) then      
local ker = database:sismember(bot_id.."XPoWeR:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_) 
if ker then        
...
if msg.content_.ID == 'MessagePhoto' and not Vips(msg) then      
local phh = database:sismember(bot_id.."XPoWeR:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_) 
if phh then        
...
if database:get(bot_id.."XPoWeR:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."XPoWeR:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."XPoWeR:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."XPoWeR:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "❈︙ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."XPoWeR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"❈︙ارسل الامر الجديد")  
database:del(bot_id.."XPoWeR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."XPoWeR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."XPoWeR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."XPoWeR:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"❈︙تم حفظ الامر")  
database:del(bot_id.."XPoWeR:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."XPoWeR:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."XPoWeR:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."XPoWeR:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."XPoWeR:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."XPoWeR:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."XPoWeR:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."XPoWeR:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."XPoWeR:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."XPoWeR:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'XPoWeR:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."XPoWeR:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:lockpin"..msg.chat_id_)  
database:srem(bot_id.."XPoWeR:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."XPoWeR:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'XPoWeR:'..lock..msg.chat_id_)    
end
...
database:del(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:Animation"..msg.chat_id_)  
...
database:del(bot_id.."XPoWeR:Lock:Sticker"..msg.chat_id_)  
...
database:hset(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"flood","kick")  
...
database:hset(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"flood","del")  
...
database:hset(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"flood","keed")  
...
database:hset(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"flood","mute")  
...
database:hdel(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"flood")  
...
function Function_XPoWeR(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XPoWeR, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_XPoWeR, nil)
return false 
end
...
if text == ("الثانويين") and DevXPoWeR(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n❈︙قائمة مطورين الثانويين للبوت \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("مسح قائمه العام") and DevXPoWeR(msg) then
database:del(bot_id.."XPoWeR:GBan:User")
send(msg.chat_id_, msg.id_, "\n❈︙تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevXPoWeR(msg) then
database:del(bot_id.."XPoWeR:Sudo:User")
send(msg.chat_id_, msg.id_, "\n❈︙ تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Constructor"..msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Manager"..msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Mod:User"..msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Special:User"..msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Muted:User"..msg.chat_id_)
...
database:del(bot_id.."XPoWeR:Ban:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "\n❈︙تم مسح المحظورين")
end
if text == ("قائمه العام") and DevXPoWeR(msg) then
local list = database:smembers(bot_id.."XPoWeR:GBan:User")
t = "\n❈︙قائمة المحظورين عام \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
if text == ("المطورين") and DevXPoWeR(msg) then
local list = database:smembers(bot_id.."XPoWeR:Sudo:User")
t = "\n❈︙قائمة مطورين البوت \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."XPoWeR:Constructor"..msg.chat_id_)
t = "\n❈︙قائمة المنشئين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."XPoWeR:Manager"..msg.chat_id_)
t = "\n❈︙قائمة المدراء \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."XPoWeR:Mod:User"..msg.chat_id_)
t = "\n❈︙قائمة الادمنيه \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."XPoWeR:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."XPoWeR:Muted:User"..msg.chat_id_)
t = "\n❈︙قائمة المكتومين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."XPoWeR:Ban:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXPoWeR(msg) then
function Function_XPoWeR(extra, result, success)
...
database:sadd(bot_id.."XPoWeR:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevXPoWeR(msg) then
...
if result.id_ == tonumber(1149393139) then
...
database:sadd(bot_id.."XPoWeR:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevXPoWeR(msg) then
...
if tonumber(userid) == tonumber(1149393139) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if tonumber(userid) == tonumber(1149393139) then
...
database:sadd(bot_id.."XPoWeR:GBan:User", userid)
Reply_Status(msg,userid,"reply","❈︙تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXPoWeR(msg) then
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","❈︙تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XPoWeR, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and DevXPoWeR(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_XPoWeR(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","❈︙تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."XPoWeR:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"❈︙لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevXPoWeR(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."XPoWeR:GBan:User", userid)
Reply_Status(msg,userid,"reply","❈︙تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXPoWeR(msg) then
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","❈︙تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XPoWeR, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevXPoWeR(msg) then
...
database:sadd(bot_id.."XPoWeR:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevXPoWeR(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."XPoWeR:Sudo:User", userid)
Reply_Status(msg,userid,"reply","❈︙تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXPoWeR(msg) then
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","❈︙تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XPoWeR, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevXPoWeR(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevXPoWeR(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."XPoWeR:Sudo:User", userid)
...
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:Constructor"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","❈︙تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XPoWeR, nil)
end
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","❈︙تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"❈︙لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","❈︙تم تنزيله من المنشئين")  
end
...
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:Manager"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:Manager"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:Special:User"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."XPoWeR:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local XPoWeRrt = database:get(bot_id.."XPoWeR:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if XPoWeRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SourceXPower")..")".."\n❈︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."XPoWeR:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif XPoWeRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SourceXPower")..")".."\n❈︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."XPoWeR:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif XPoWeRrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SourceXPower")..")".."\n❈︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."XPoWeR:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif XPoWeRrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SourceXPower")..")".."\n❈︙تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif XPoWeRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SourceXPower")..")".."\n❈︙تم تنزيله من "..RTPA.." هنا\n")  
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."XPoWeR:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local XPoWeRrt = database:get(bot_id.."XPoWeR:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if XPoWeRrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "SourceXPower")..")".."\n❈︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."XPoWeR:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif XPoWeRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "SourceXPower")..")".."\n❈︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."XPoWeR:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif XPoWeRrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"[- XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/SourceXPower)\n — — — — — — — — —\n❈︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "SourceXPower")..")".."\n❈︙تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."XPoWeR:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
function Function_XPoWeR(extra, result, success)
if result.sender_user_id_ == tonumber(1149393139) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1149393139) then
...
database:sadd(bot_id.."XPoWeR:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Ban:User"..msg.chat_id_, result.id_)
...
if userid == tonumber(1149393139) then
send(msg.chat_id_, msg.id_, "❈︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1149393139) then
...
database:sadd(bot_id.."XPoWeR:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."XPoWeR:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."XPoWeR:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id..'XPoWeR:XPoWeR:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","❈︙تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'XPoWeR:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'XPoWeR:XPoWeR:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'XPoWeR:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","❈︙تم قفـل الفشار")  
end
if text and database:get(bot_id..'XPoWeR:XPoWeR:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'XPoWeR:lock:Fshar'..msg.chat_id_) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'XPoWeR')..') '
...
if database:sismember(bot_id.."XPoWeR:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."XPoWeR:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."XPoWeR:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"❈︙انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"❈︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:setex(bot_id.."XPoWeR:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "الرابط" then 
...
local status_Link = database:get(bot_id.."XPoWeR:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"❈︙جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."XPoWeR:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:set(bot_id.."XPoWeR:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."XPoWeR:Link_Group"..msg.chat_id_) 
...
database:del(bot_id.."XPoWeR:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:sadd(bot_id.."XPoWeR:allM"..msg.chat_id_, msg.id_)
end
...
local gmedia = database:scard(bot_id.."XPoWeR:allM"..msg.chat_id_)  
if gmedia == 200 then
local liste = database:smembers(bot_id.."XPoWeR:allM"..msg.chat_id_)
...
send(msg.chat_id_, msg.id_, t)
database:del(bot_id.."XPoWeR:allM"..msg.chat_id_)
end
end
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."XPoWeR:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = database:scard(bot_id.."XPoWeR:allM"..msg.chat_id_)  
...
database:set(bot_id.."XPoWeR:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."XPoWeR:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."XPoWeR:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."XPoWeR:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."XPoWeR:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."XPoWeR:Chek:Welcome"..msg.chat_id_,true) 
...
database:del(bot_id.."XPoWeR:Chek:Welcome"..msg.chat_id_) 
...
if Addictive(msg) then
database:del(bot_id.."XPoWeR:Get:Welcome:Group"..msg.chat_id_) 
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://XPoWeR-source.tk/XPoWeRTeAM/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
database:set(bot_id.."XPoWeR:Filter:msg",msg.chat_id_)
tdcli_function ({ID = "GetUser",user_id_ = bot_id},function(arg,data) 
...
local listtext = database:smembers(bot_id.."XPoWeR:List:Filter:text"..msg.chat_id_)  
for k,v in pairs(listtext) do  
database:srem(bot_id.."XPoWeR:List:Filter:text"..msg.chat_id_,v)  
end  
local listAnimation = database:smembers(bot_id.."XPoWeR:List:Filter:Animation"..msg.chat_id_)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."XPoWeR:List:Filter:Animation"..msg.chat_id_,v)  
end  
local listSticker = database:smembers(bot_id.."XPoWeR:List:Filter:Sticker"..msg.chat_id_)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."XPoWeR:List:Filter:Sticker"..msg.chat_id_,v)  
end  
local listPhoto = database:smembers(bot_id.."XPoWeR:List:Filter:Photo"..msg.chat_id_)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."XPoWeR:List:Filter:Photo"..msg.chat_id_,v)  
end  
...
database:set(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"❈︙تم منع الكلمه بنجاح")  
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."XPoWeR:List:Filter:text"..msg.chat_id_,text)  
return false 
end  
end
...
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."XPoWeR:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."XPoWeR:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false 
end  
end
...
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:sadd(bot_id.."XPoWeR:List:Filter:Photo"..msg.chat_id_,msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false 
end  
end
...
database:set(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false 
end
if text then 
local test = database:get(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء منعها ")  
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."XPoWeR:List:Filter:text"..msg.chat_id_,text)  
return false
end  
end
if msg.content_.ID == 'MessageAnimation' then    
local onte = database:get(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if onte and onte == "reppp" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء منع المتحركه بنجاح ")  
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."XPoWeR:List:Filter:Animation"..msg.chat_id_,msg.content_.animation_.animation_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessageSticker' then    
local Stic = database:get(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if Stic and Stic == "reppp" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء منع الملصق بنجاح ")  
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."XPoWeR:List:Filter:Sticker"..msg.chat_id_,msg.content_.sticker_.sticker_.persistent_id_)  
return false
end  
end
if msg.content_.ID == 'MessagePhoto' then    
local hoto = database:get(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if hoto and hoto == "reppp" then   
send(msg.chat_id_, msg.id_,"❈︙تم الغاء منع الصوره بنجاح ")  
database:del(bot_id.."XPoWeR:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:srem(bot_id.."XPoWeR:List:Filter:Photo"..msg.content_.photo_.sizes_[1].photo_.persistent_id_)  
return false
end  
end
...
if database:get(bot_id.."XPoWeR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "❈︙تم الغاء حفظ القوانين") 
database:del(bot_id.."XPoWeR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."XPoWeR:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."XPoWeR:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."XPoWeR:Set:Rules:Group"..msg.chat_id_) 
end
end
...
local Set_Rules = database:get(bot_id.."XPoWeR:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_.."")
t = "❈︙قائمه الاوامر المضافه  \n — — — — — — — — — \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"❈︙تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "ترتيب الاوامر" and Constructor(msg) then
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
database:set(bot_id.."XPoWeR:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
if Constructor(msg) then
database:set(bot_id.."XPoWeR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_XPoWeR(extra, result, success)
database:sadd(bot_id.."XPoWeR:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."XPoWeR:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."XPoWeR:MN:TF"..msg.chat_id_, userid)
...
function Function_XPoWeR(extra, result, success)
database:srem(bot_id.."XPoWeR:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
database:srem(bot_id.."XPoWeR:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."XPoWeR:MN:TF"..msg.chat_id_, userid)
...
local list = database:smembers(bot_id.."XPoWeR:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."XPoWeR:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
database:del(bot_id.."XPoWeR:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."XPoWeR:MN:TF"..msg.chat_id_)
t = "\n❈︙قائمة المنظفين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."XPoWeR:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."XPoWeR:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."XPoWeR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."XPoWeR:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."XPoWeR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."XPoWeR:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "❈︙تم مسح الصلاحيه ") 
end
if database:get(bot_id.."XPoWeR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"❈︙تم الغاء الامر ") 
database:del(bot_id.."XPoWeR:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."XPoWeR:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."XPoWeR:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."XPoWeR:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد المطور الى -› "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."XPoWeR:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد المنشئ الاساسي الى -› "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."XPoWeR:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد المنشئ الى -› "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."XPoWeR:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد المدير الى -› "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."XPoWeR:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد الادمن الى -› "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."XPoWeR:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد المميز الى -› "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."XPoWeR:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"❈︙ تم تغير رد العضو الى -› "..Teext)
end
if text == ("مسح الرتب") and BasicConstructor(msg) then
send(msg.chat_id_, msg.id_,"❈︙ تم مسح ردود الرتب بنجاح ")
database:del(bot_id.."XPoWeR:Sudo:Rd"..msg.chat_id_)
database:del(bot_id.."XPoWeR:BasicConstructor:Rd"..msg.chat_id_)
database:del(bot_id.."XPoWeR:Constructor:Rd"..msg.chat_id_)
database:del(bot_id.."XPoWeR:Manager:Rd"..msg.chat_id_) 
database:del(bot_id.."XPoWeR:Mod:Rd"..msg.chat_id_)
database:del(bot_id.."XPoWeR:Special:Rd"..msg.chat_id_)
database:del(bot_id.."XPoWeR:Memp:Rd"..msg.chat_id_)
end
if text == ("مسح ردود المدير") and BasicConstructor(msg) then
local list = database:smembers(bot_id.."XPoWeR:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."XPoWeR:Add:Rd:Manager:AudioCa"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:FileCa"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:VideoCa"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:PhotoCa"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:VicoCa"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:GifCa"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."XPoWeR:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."XPoWeR:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق ⌔"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره ⌔"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ⌔"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") -› {"..db.."}\n"
end
...
local test = database:get(bot_id.."XPoWeR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:VicoCa"..test..msg.chat_id_, rtr)  
end
end     
if msg.content_.animation_ then   
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:GifCa"..test..msg.chat_id_, rtr)  
end
end  
if text then   
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:AudioCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.document_ then
database:set(bot_id.."XPoWeR:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:FileCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.video_ then
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:VideoCa"..test..msg.chat_id_, rtr)  
end
end  
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."XPoWeR:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
if msg.content_.caption_ then
rtr = msg.content_.caption_
rtr = rtr:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Manager:PhotoCa"..test..msg.chat_id_, rtr)  
end
end  
...
database:set(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '❈︙الان ارسل الرد الذي تريد اضافته \n❈︙ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n❈︙ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."XPoWeR:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."XPoWeR:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"❈︙تم ازالة الرد من قائمه الردود")
database:del(bot_id.."XPoWeR:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:FileCa"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:GifCa"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
database:del(bot_id.."XPoWeR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."XPoWeR:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."XPoWeR:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."XPoWeR:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'XPoWeR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Photo"..text..msg.chat_id_)  
local video = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Video"..text..msg.chat_id_) 
local document = database:get(bot_id.."XPoWeR:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."XPoWeR:Add:Rd:Manager:Audio"..text..msg.chat_id_)
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
if Text then 
local NumMsg = database:get(bot_id..'XPoWeR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
database:sadd(bot_id.."XPoWeR:Spam:Group"..msg.sender_user_id_,text) 
end
if stekr then 
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local veicoCa = database:get(bot_id.."XPoWeR:Add:Rd:Manager:VicoCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local videoCa = database:get(bot_id.."XPoWeR:Add:Rd:Manager:VideoCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local anemiCa = database:get(bot_id.."XPoWeR:Add:Rd:Manager:GifCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local documentCa = database:get(bot_id.."XPoWeR:Add:Rd:Manager:FileCa"..text..msg.chat_id_) or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local audioCa = database:get(bot_id.."XPoWeR:Add:Rd:Manager:AudioCa"..text..msg.chat_id_)  or ""
...
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local photoCa = database:get(bot_id.."XPoWeR:Add:Rd:Manager:PhotoCa"..text..msg.chat_id_) or ""
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevXPoWeR(msg) then 
local list = database:smembers(bot_id.."XPoWeR:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:File"..v)
database:del(bot_id.."XPoWeR:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."XPoWeR:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"❈︙تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevXPoWeR(msg) then 
local list = database:smembers(bot_id.."XPoWeR:List:Rd:Sudo")
text = "\n❈︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
if database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:stekr"..v) then
db = "ملصق ⌔"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Photo"..v) then
db = "صوره ⌔"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") -› {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."XPoWeR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."XPoWeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."XPoWeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."XPoWeR:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"❈︙تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevXPoWeR(msg) then 
send(msg.chat_id_, msg.id_,"❈︙ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."XPoWeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevXPoWeR(msg) then 
send(msg.chat_id_, msg.id_,"❈︙ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."XPoWeR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."XPoWeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '❈︙الان ارسل الرد الذي تريد اضافته \n❈︙ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n❈︙ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."XPoWeR:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."XPoWeR:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."XPoWeR:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."XPoWeR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"❈︙تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'XPoWeR:'..v..text)
end
database:del(bot_id.."XPoWeR:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."XPoWeR:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."XPoWeR:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'XPoWeR:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."XPoWeR:Add:Rd:Sudo:Audio"..text)
...
function Function_XPoWeR(extra, result, success)
if DevXPoWeRe(result.sender_user_id_)  then
...
if DevXPoWeRe(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."XPoWeR:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."XPoWeR:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."XPoWeR:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."XPoWeR:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_XPoWeR, nil)
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."XPoWeR:User:Name"..v.user_id_) then
t = t.."❈︙"..x.."︙[@"..database:get(bot_id.."XPoWeR:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
if not database:get(bot_id.."XPoWeR:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."XPoWeR:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
...
database:set(bot_id.."XPoWeR:Kick:Me"..msg.chat_id_,true)  
Text = "\n❈︙تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_XPoWeR(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."XPoWeR:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."XPoWeR:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_XPoWeR(extra, result, success)
if database:sismember(bot_id.."XPoWeR:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."XPoWeR:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."XPoWeR:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."XPoWeR:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "SourceXPower")
...
if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."XPoWeR:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"❈︙ تم مغادرة المجموعه") 
database:srem(bot_id.."XPoWeR:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."XPoWeR:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevXPoWeR(msg) then   
database:del(bot_id.."XPoWeR:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"❈︙تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevXPoWeR(msg) then  
database:set(bot_id.."XPoWeR:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "❈︙تم تعطيل مغادرة البوت") 
return false 
end
if text == (database:get(bot_id.."XPoWeR:Name:Bot") or "اكس باور") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."XPoWeR:Name:Bot") or "اكس باور")
local namebot = {
...
if DevXPoWeR(msg) then
database:setex(bot_id.."XPoWeR:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."XPoWeR:Status:Bc") and not DevXPoWeR(msg) then 
send(msg.chat_id_, msg.id_,"❈︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."XPoWeR:XPoWeR:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."XPoWeR:XPoWeR:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❈︙ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n❈︙للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."XPoWeR:XPoWeR:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❈︙ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n❈︙للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."XPoWeR:XPoWeR:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."XPoWeR:XPoWeR:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❈︙ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevXPoWeR(msg) then  
database:del(bot_id.."XPoWeR:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n❈︙تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevXPoWeR(msg) then  
database:set(bot_id.."XPoWeR:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n❈︙تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."XPoWeR:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."XPoWeR:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."XPoWeR:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."XPoWeR:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."XPoWeR:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."XPoWeR:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."XPoWeR:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."XPoWeR:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."XPoWeR:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."XPoWeR:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."XPoWeR:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."XPoWeR:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n❈︙ااعدادات المجموعه "..
"\n — — — — — — — — — "..
"\n❈︙علامة ال {✓} تعني مفعل"..
...
database:set(bot_id.."XPoWeR:Fun_Bots"..msg.chat_id_,"true")
end
...
database:del(bot_id.."XPoWeR:Fun_Bots"..msg.chat_id_)
end
...
database:del(bot_id..'XPoWeR:Lock:ID:Bot'..msg.chat_id_) 
...
database:set(bot_id..'XPoWeR:Lock:ID:Bot'..msg.chat_id_,true) 
...
database:del(bot_id..'XPoWeR:Lock:ID:Bot:Photo'..msg.chat_id_) 
...
database:set(bot_id..'XPoWeR:Lock:ID:Bot:Photo'..msg.chat_id_,true) 
...
database:setex(bot_id.."XPoWeR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
❈︙ ارسل الان النص
❈︙ يمكنك اضافه :
- `#username` > اسم المستخدم
...
if Owner(msg) then
database:del(bot_id.."XPoWeR:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '❈︙تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."XPoWeR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"❈︙تم الغاء تعين الايدي") 
database:del(bot_id.."XPoWeR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."XPoWeR:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."XPoWeR:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'❈︙تم تعين الايدي')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'XPoWeR:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'XPoWeR:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."XPoWeR:Spam:Group"..msg.sender_user_id_,text) 
...
local Add_Mem = database:get(bot_id.."XPoWeR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."XPoWeR:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'XPoWeR:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
if not database:get(bot_id..'XPoWeR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'XPoWeR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
if not database:get(bot_id..'XPoWeR:Lock:ID:Bot'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'XPoWeR:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."XPoWeR:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
inline = {{{text = '- اضغط هنا للمسح.',callback_data=msg.sender_user_id_..":cancelRd:add"}}, }
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'XPoWeR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '❈︙عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'XPoWeR:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '❈︙تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '❈︙عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'XPoWeR:message_edit'..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, '❈︙تم مسح جميع تعديلاتك ') 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."XPoWeR:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '❈︙عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'XPoWeR:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."XPoWeR:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."XPoWeR:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."XPoWeR:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevXPoWeR(msg) then
local pv = database:smembers(bot_id..'XPoWeR:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'XPoWeR:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevXPoWeR(msg) then
local group = database:smembers(bot_id..'XPoWeR:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'XPoWeR:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and DevXPoWeR(msg) then  
...
database:set(bot_id.."XPoWeR:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'❈︙ تم تفعيل الزخرفه')
database:set(bot_id.."XPoWeR:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."XPoWeR:zhrf_Bots"..msg.chat_id_) == "open" then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❈︙قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
database:set(bot_id.."XPoWeR:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'❈︙ تم تفعيل الابراج')
database:set(bot_id.."XPoWeR:brj_Bots"..msg.chat_id_,"open")
end
if text == "تعطيل كت تويت" and Owner(msg) then
send(msg.chat_id_, msg.id_, '❈︙ تم تعطيل كت تويت')
database:set(bot_id.."XPoWeR:Qut"..msg.chat_id_,true)
end
if text == "تفعيل كت تويت" and Owner(msg) then
send(msg.chat_id_, msg.id_,'❈︙ تم تفعيل كت تويت')
database:del(bot_id.."XPoWeR:Qut"..msg.chat_id_)
end
if text == "كت" or  text == "كت تويت" and not  database:get(bot_id.."XPoWeR:Qut"..msg.chat_id_) then
...
if text and text:match("^برج (.*)$") and database:get(bot_id.."XPoWeR:brj_Bots"..msg.chat_id_) == "open" then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
send(msg.chat_id_, msg.id_, br.ok.hso)
end
if text == "الابراج" and database:get(bot_id.."XPoWeR:brj_Bots"..msg.chat_id_) == "open" then
key = {
...
database:set(bot_id.."XPoWeR:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'❈︙ تم تفعيل حساب العمر')
database:set(bot_id.."XPoWeR:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."XPoWeR:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == "تعطيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_, '❈︙ تم تعطيل الانستا')
database:set(bot_id.."XPoWeR:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'❈︙ تم تفعيل الانستا')
database:set(bot_id.."XPoWeR:insta_bot"..msg.chat_id_,"open")
end
if database:get(bot_id.."XPoWeR:insta_bot"..msg.chat_id_) == "open" then
if text and text:match("^معلومات (.*)$")  then
request = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/infoInstagram.php?username='..URL.escape(text:match("^معلومات (.*)$")))
...
database:set(bot_id.."XPoWeR:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'❈︙ تم تفعيل الافلام')
database:set(bot_id.."XPoWeR:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."XPoWeR:movie_bot"..msg.chat_id_) == "open" then
local Textm = text:match("^فلم (.*)$")
data,res = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/audios.php')
if res == 200 then
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."XPoWeR:Lock:Xn"..msg.chat_id_)=="del" then      
sticker_id = msg.content_.sticker_.sticker_.persistent_id_
st = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."XPoWeR:Lock:Xn"..msg.chat_id_)=="del" then
photo_id = msg.content_.photo_.sizes_[1].photo_.persistent_id_  
Srrt = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'تفعيل البوت الخدمي' and DevXPoWeR(msg) then  
database:del(bot_id..'XPoWeR:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'❈︙تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevXPoWeR(msg) then  
database:set(bot_id..'XPoWeR:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'❈︙تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevXPoWeR(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'XPoWeR:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'❈︙ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'XPoWeR:Chek:Groups')  
local Users = database:scard(bot_id..'XPoWeR:UsersBot')  
send(msg.chat_id_, msg.id_,'❈︙احصائيات البوت \n\n❈︙عدد المجموعات *~ '..Groups..'\n❈︙عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevXPoWeR(msg) then
local list = database:smembers(bot_id..'XPoWeR:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'XPoWeR Chat'
ASAS = database:smembers(bot_id.."XPoWeR:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."XPoWeR:Constructor"..v)
MDER = database:smembers(bot_id.."XPoWeR:Manager"..v)
MOD = database:smembers(bot_id.."XPoWeR:Mod:User"..v)
link = database:get(bot_id.."XPoWeR:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"XPoWeR":"'..NAME..'",'
else
t = t..',"'..v..'":{"XPoWeR":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'XPoWeR:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevXPoWeR(msg) then
t = '❈︙جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls XPoWeR_Files'):lines() do
if v:match(".lua$") then
...
if Get_info then
local TextS = "\n❈︙اهلا بك في متجر ملفات اكس باور\n❈︙يوجد في المتجر ملف الردود\n❈︙يتم ادراج الملفات في التحديثات القادمه \n — — — — — — — — — \n"
local TextE = "\n — — — — — — — — — \n❈︙تدل علامة (✔) الملف مفعل\n".."❈︙تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("XPoWeR_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevXPoWeR(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("XPoWeR_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevXPoWeR(msg) then
...
if text == "مسح جميع الملفات" and DevXPoWeR(msg) then
os.execute("rm -fr XPoWeR_Files/*")
send(msg.chat_id_,msg.id_,"❈︙تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevXPoWeR(msg) then
local Users = database:smembers('XPoWeR:'..bot_id.."userss")
local Groups = database:smembers('XPoWeR:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'XPoWeR:Chek:Groups',Groups[i])  
end
for i = 1, #Users do
database:sadd(bot_id..'XPoWeR:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'❈︙تم نقل : '..#Groups..' كروب\n❈︙تم نقل : '..#Users..' مشترك \n❈︙من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevXPoWeR(msg) then
database:del(bot_id..'XPoWeR:Text_Dev')
send(msg.chat_id_, msg.id_,'❈︙ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevXPoWeR(msg) then
database:set(bot_id..'XPoWeR:Set:Text_Dev'..msg.chat_id_,true)
send(msg.chat_id_,msg.id_,'❈︙ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'XPoWeR:Set:Text_Dev'..msg.chat_id_) then
if text == 'الغاء' then 
database:del(bot_id..'XPoWeR:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'❈︙تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'XPoWeR:Text_Dev',text)
database:del(bot_id..'XPoWeR:Set:Text_Dev'..msg.chat_id_)
send(msg.chat_id_,msg.id_,'❈︙تم حفظ كليشة المطور')
return false
end
if text == 'رفع النسخه الاحتياطيه' and DevXPoWeR(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevXPoWeR(msg) then
dofile("XPoWeR.lua")  
send(msg.chat_id_, msg.id_, "❈︙تم التحديث")
end
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' then  
Text = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n• [XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .](http://t.me/SourceXPower) \n• [XPoWeR Developer .](http://t.me/Mooauid) \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾 .',url="t.me/SourceXPower"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceXPower&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
end
...
send_inline_key(msg.chat_id_,"*- 𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘵𝘩𝘦 XPoWeR 𝘴𝘰𝘶𝘳𝘤𝘦 .*",nil,key,msg.id_/2097152/0.5)
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'XPoWeR:Num:Add:Bot') or 0) and not DevXPoWeR(msg) then
send(msg.chat_id_, msg.id_,'❈︙عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'XPoWeR:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'XPoWeR:Chek:Groups',msg.chat_id_) then
...
database:sadd(bot_id..'XPoWeR:Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'XPoWeR:Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'XPoWeR:Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
database:sadd(bot_id..'XPoWeR:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'XPoWeR:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'XPoWeR:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'XPoWeR:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if text and text:match("^/start ph(.*)$") then
Sf = database:get(bot_id.."XPoWeR:Filter:msg")
local list = database:smembers(bot_id.."XPoWeR:List:Filter:Photo"..Sf)  
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."XPoWeR:List:Filter:text"..sl)
...
local list = database:smembers(bot_id.."XPoWeR:List:Filter:Animation"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
local list = database:smembers(bot_id.."XPoWeR:List:Filter:Sticker"..Sf)
for k,v in pairs(list) do
if v then
inline = {
...
if not DevXPoWeR(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."XPoWeR:Filter"..msg.sender_user_id_) then
...
if DevXPoWeR(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if database:get(bot_id.."XPoWeRBTSS:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ⌔" then   
send(msg.chat_id_, msg.id_,"❈︙ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."XPoWeRBTSS:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."XPoWeRBTSS:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."XPoWeR:Name:Bot",text) 
...
database:setex(bot_id.."XPoWeRBTSS:Set:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"❈︙ ارسل لي الاسم الان ")  
end
...
thumb_url = 'https://XPoWeR-source.tk/geam1.jpg'
},{
type = 'article',
id = math.random(1,64),
title = 'ورقه',
...
thumb_url = 'https://XPoWeR-source.tk/geam2.jpg'	
},{
type = 'article',
id = math.random(1,64),
title = 'مقص',
...
thumb_url = 'https://XPoWeR-source.tk/geam3.jpg'	
}
}
...
database:srem(bot_id..'XPoWeR:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
gk = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/Horoscopes.php?br='..URL.escape(OnID))
br = JSON.decode(gk)
x = {} 
x.inline_keyboard = {
{{text = '❈︙ XPoWeR 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/SourceXPower'}},
}
...
database:srem(bot_id.."XPoWeR:List:Filter:Animation"..idchci,animation)  
end
if DAata and DAata:match("^pito(.*)$") and Addictive(data) then  
local idchci = database:get(bot_id.."XPoWeR:Filter:msg")
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."XPoWeR:List:Filter:Photo"..idchci,photo)  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
database:srem(bot_id.."XPoWeR:List:Filter:Sticker"..idchci,Sticker)  
end
if DAata and DAata:match("^delallSticker(.*)$") and Addictive(data) then  
local delallSticker = DAata:match("^delallSticker(.*)$")
local Text ="❈︙تم اللغاء منع كل المتحركات"
inline = {
{{text = '❈︙ XPoWeR 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/SourceXPower'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listSticker = database:smembers(bot_id.."XPoWeR:List:Filter:Sticker"..delallSticker)  
for k,v in pairs(listSticker) do  
database:srem(bot_id.."XPoWeR:List:Filter:Sticker"..delallSticker,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listAnimation = database:smembers(bot_id.."XPoWeR:List:Filter:Animation"..delallmation)  
for k,v in pairs(listAnimation) do  
database:srem(bot_id.."XPoWeR:List:Filter:Animation"..delallmation,v)  
end  
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
local listPhoto = database:smembers(bot_id.."XPoWeR:List:Filter:Photo"..delallph)  
for k,v in pairs(listPhoto) do  
database:srem(bot_id.."XPoWeR:List:Filter:Photo"..delallph,v)  
end  
end
...
object = https.request('https://XPoWeR-source.tk/Api/InfoVid.php?url=http://www.youtube.com/watch?v='..URL.escape(id_from_vid))
...
InfoVid = https.request('https://XPoWeR-source.tk/Api/BotYoutube.php?Id='..URL.escape(id_from_vid))
InfoVidend = JSON.decode(InfoVid)
if InfoVidend.Info.video == "not" then  
https.request("https://XPoWeR-source.tk/XPoWeRTeAM/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
https.request("https://XPoWeR-source.tk/XPoWeRTeAM/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
...
if database:get(bot_id.."XPoWeR:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_) then
database:del(bot_id.."XPoWeR:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_)
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
if text and not database:sismember(bot_id..'XPoWeR:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'XPoWeR:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'XPoWeR:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."XPoWeR:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."XPoWeR:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."XPoWeR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."XPoWeR:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."XPoWeR:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."XPoWeR:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."XPoWeR:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."XPoWeR:Name:Bot") or "اكس باور")
if not database:get(bot_id.."XPoWeR:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
XPoWeR_Started_Bot(msg,data)
XPoWeR_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'XPoWeR:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."XPoWeR:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
local list = database:smembers(bot_id.."XPoWeR:Basic:Constructor"..msg.chat_id_)
t = "❈︙ المنشئين الاساسين تعالو مخرب \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."XPoWeR:User:Name" .. v)
...
if database:get(bot_id.."XPoWeR:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."XPoWeR:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."XPoWeR:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."XPoWeR:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local XPoWeR_Msg = database:sismember(bot_id.."XPoWeR:List:Filter:text"..result.chat_id_,text) 
if XPoWeR_Msg then    
...
if msg.content_.ID == 'MessageAnimation' then    
local Animation_Msg = database:sismember(bot_id.."XPoWeR:List:Filter:Animation"..result.chat_id_,result.content_.animation_.animation_.persistent_id_) 
...
if msg.content_.ID == 'MessagePhoto' then    
local Photo_Msg = database:sismember(bot_id.."XPoWeR:List:Filter:Photo"..result.chat_id_,result.content_.photo_.sizes_[1].photo_.persistent_id_) 
if Photo_Msg then    
...
if msg.content_.ID == 'MessageSticker' then    
local Sticker_Msg = database:sismember(bot_id.."XPoWeR:List:Filter:Sticker"..result.chat_id_,result.content_.sticker_.sticker_.persistent_id_) 
if Sticker_Msg then    
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'XPoWeR:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'XPoWeR:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'XPoWeR:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
>> The Bot is Running
>> Bot source > XPoWeR
>>Source channel > @SourceXPower
>>Source developer > @Mooaiud
 ____  _        _    ____ _  __
|
| ____  _        _    ____ _  __
|
...
database:srem(bot_id..'XPoWeR:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'XPoWeR:Chek:Groups',v)  
end
...
database:sadd(bot_id..'XPoWeR:Chek:Groups',v)  
end end,nil)
