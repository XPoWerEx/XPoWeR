...
local UserName = (data.username_ or "X_PoWeR_TeaM")
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/X_PoWeR_TeaM) \n✬︙[قناه السورس](t.me/X_PoWeR_TeaM)')
end
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'X_PoWeR_TeaM')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'X_PoWeR_TeaM')..')'
status  = '\n*✬︙تم ترقيته مطور*'
...
if XPoWeR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'X_PoWeR_TeaM')..') \n ✬︙'..XPoWeR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/X_PoWeR_TeaM)}\n✬︙["..XPoWeR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/X_PoWeR_TeaM)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X_PoWeR_TeaM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'X_PoWeR_TeaM')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'X_PoWeR_TeaM')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
local TextE = "\n*•━━━━━━ XPoWeR ━━━━━━━•*\n *✬︙علامة تعني { ✓ } ملف مفعل*\n *✬︙علامة تعني { ✘ } ملف معطل*\n *✬︙قناة سورس اكس باور ↓*\n".." *✬︙*[اضغط هنا لدخول](t.me/X_PoWeR_TeaM) \n"
local NumFile = 0
...
local UserName = (b.username_ or "X_PoWeR_TeaM")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'X_PoWeR_TeaM')..')'
status  = '\n*✬︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'X_PoWeR_TeaM')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'X_PoWeR_TeaM')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'X_PoWeR_TeaM')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'X_PoWeR_TeaM')..')'
local iduser = result.sender_user_id_
...
*✬م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ XPoWeR ━━━━━━━•*ٴ
[- SouRce XPoWeR ](t.me/X_PoWeR_TeaM) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '- SouRce XPoWeR', url="t.me/X_PoWeR_TeaM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '~ XPoWeR •',url='http://t.me/X_PoWeR_TeaM'}},
}
...
inline = {
{{text = 'SouRce XPoWeR',url='http://t.me/X_PoWeR_TeaM'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
