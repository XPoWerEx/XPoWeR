...
io.popen("cd library && wget https://raw.githubusercontent.com/XPoWerEx/XPoWeR/master/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/XPoWerEx/XPoWeR/master/File_Bot/commands.lua") 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: XPoWeR SouRce .',url="t.me/SourceXPower/567"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevXPoWeRW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/XPoWerEx/XPoWeR/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/XPoWerEx/XPoWeR/master/File_Bot/"..file)
if res == 200 then
...
*✬م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ XPoWeR ━━━━━━━•*ٴ
[- SouRce XPoWeR ](t.me/SourceXPower) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '- SouRce XPoWeR', url="t.me/SourceXPower"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
inline = {
{{text = 'SouRce XPoWeR',url='http://t.me/SourceXPower'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
