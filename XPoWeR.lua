...
local url,res = https.request('https://XPoWeR-source.tk/XPoWeRTeAM/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'❈︙شترك في قناة السورس اولآ @SourceXPower .')   
return false 
end
key = {
{{text = '- 𝘉𝘭𝘢𝘤𝘬 𝘛𝘦𝘢𝘮 .',url="t.me/SourceXPower"}},
{{text = '- 𝘊𝘢𝘭𝘭 𝘜𝘴 .',url="t.me/TwSLXPoWeRBot"}},
}
